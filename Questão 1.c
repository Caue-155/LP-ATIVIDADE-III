...
int main()
{
    ...
    for (a = 0; a < 5; a++)
    {
        printf("\nInforme o nome do %d° usuário: ", a + 1);
        scanf("%s", &nome[a]);

        fflush(stdin);

        printf("Informe a idade do usuário:", nome[a]);
        scanf("%d", &idade[a]);

        printf("Informe o peso do usuário em kg: ", nome[a]);
        scanf("%f", &peso[a]);

        printf("Informe a altura do usuário em metros: ", nome[a]);
        scanf("%f", &altura[a]);
